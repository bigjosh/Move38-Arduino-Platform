...
namespace ir_packet_header_enum {
    ...
    enum {
        ...
        ACTIVE  =   0b11101000,      // Send to our source any time we get a valid pull or active packet. Basically this is an empty pull to reset the source's timeout
        FINISHED=   0b00011100,      // Send to our source when we have not seen a pull or active lately
